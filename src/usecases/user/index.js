...
const login = async (email, password) => {
    ...
    if (!userDb) throw new HTTPError(404, 'User not found, please create account');
    if (!bcrypt.compareSync(password, userDb.password)) throw new HTTPError(401, 'Email or password is incorrect');
    const user = {
